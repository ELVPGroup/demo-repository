...
import { LogisticsProvider, Order, OrderStatus, PackageData } from './types';
  ...
  steps: [
    {
      ...
      date: "Today",
      time: "10:42",
      description: "Courier [Master Wang 13800000000] is delivering to you, please keep your phone open.",
      completed: false,
      current: true
    },
    {
      ...
      date: "Today",
      time: "08:31",
      description: "Express arrived at [Shanghai Xuhui Distribution Center], preparing to send to [Shanghai Xuhui Delivery Dept]",
      completed: true,
      current: false
    },
    {
